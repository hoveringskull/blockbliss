...
@warning_ignore("unused_signal") signal request_hide_menu

@warning_ignore("unused_signal") signal on_score_updated
@warning_ignore("unused_signal") signal on_game_lost
@warning_ignore("unused_signal") signal on_new_next_shape
@warning_ignore("unused_signal") signal on_row_clear
